...
val books: List[Book] = List(
  ...
  Book(title = "Effective Java3", authors = List("Bloch, Joshua")),
  Book(
    title = "Java Puzzlers",
...
// alternatively, we can construct a mini database with sets of rows such that we use "Sets"" not "Lists"
// Example below 


val books_set:Set[Book] = Set(
  Book(
    title = "Structure and Interpretation of Computer Programs",
    authors = List("Abelson, Harald", "Sussman, Gerald J.")
  ),
...
// now we dont have a duplication based on the set above 
